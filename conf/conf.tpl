...
////////////////////////////////////////////////////////
$project="Max and Vlad Hosting";
$link= "#";


//MYSQL config
$loc= "localhost";                              //HOST name
$us = "root";                                   //HOST user
$pwd = "";                                      //HOST password
$dbname="filehost";                            //HOST datebase name
$profiles="users";                              //table name
...
$class_path="/classes/class";
$class_path_up="./classes/class";
?>
